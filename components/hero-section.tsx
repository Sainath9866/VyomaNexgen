  ...
  return (
    <div className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
      ...
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] z-20"></div>
        <div id='hero' className="w-full relative min-h-screen z-30">
          {/* Animated background gradient */}
          <div className="relative container mx-auto pb-24 sm:pt-32 sm:pb-32 ">
            {/* Badge */}
            <motion.div
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-foreground to-muted-foreground mb-6 z-50"
            >
              Build amazing websites <br /> with <Cover><span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">Vyomo Nexgen</span></Cover>
            </motion.h1>
            {/* Subheading */}
            <motion.p
              initial={{ opacity: 0, y: 20 }}
